...
var REWARDS_CONFIG = {
    ...
    kingsity: {
        rewardBonus: 0,
        // Группы 1-3 - для победившей команды (ранжируются по убыванию
        // finalKills*2 + throneBreaks*3), группы 4-5 - для проигравшей.
        // players - сколько человек попадёт в группу (по рангу, сверху вниз
        // по объединённому списку: сначала все победители, потом проигравшие).
        // Подберите players под реальный размер команд на вашем сервере -
        // если players в сумме (1+2+5=8) меньше, чем игроков в победившей
        // команде, "лишние" победители уедут в группу 6 (0 черепов) вместо 4-5!
        rewardGroups: [
            { players: 1, skulls: 6 },  // группа 1: лучший игрок победившей команды
            { players: 2, skulls: 4 },  // группа 2: следующие 2 победителя
            { players: 5, skulls: 2 },  // группа 3: остальные победители
            { players: 3, skulls: 2 },  // группа 4: лучшие 3 из проигравшей команды
            { players: 5, skulls: 1 },  // группа 5: остальные проигравшие
            { players: 0, skulls: 0 }   // группа 6: консольная (все, кто не попал выше)
        ],
        specialRewards: {
            topThroneBreaker: 3,
            topKiller: 3
